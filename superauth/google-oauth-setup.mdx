---
title: 'Setup Gmail and Calendar integration'
description: "Connect Gmail and Google Calendar to your AI agent using the agentor setup-google command — handles OAuth credentials and browser-based authentication."
---

<img src="/assets/undraw_security-on_3ykb.png" alt="Google OAuth Setup" className="rounded-lg" width="500" />
