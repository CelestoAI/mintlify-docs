...
description: "An E-commerce Agent handles product discovery, order tracking, returns, personalized recommendations, and upsells through natural conversation in real time."
---
