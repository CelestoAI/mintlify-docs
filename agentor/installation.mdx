...
<Warning>
  LiteLLM versions `1.82.7` and `1.82.8` have been excluded due to a known security issue. Agentor automatically avoids these versions during installation. If you have either version installed, upgrade with:
