---
title: "A2AController"
description: "A2AController class reference: a FastAPI router that exposes an agent card manifest and handles JSON-RPC messaging for the A2A protocol v0.3.0."
---
