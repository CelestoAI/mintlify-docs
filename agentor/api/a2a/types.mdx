---
title: "A2A Types"
description: "Reference for A2A protocol type definitions including JSONRPCRequest, JSONRPCResponse, AgentCard, AgentSkill, and message types from the a2a-sdk."
---
