...
description: "CalculatorTool reference: give Agentor agents add, subtract, multiply, and divide capabilities for precise numerical calculations during reasoning tasks."
---
