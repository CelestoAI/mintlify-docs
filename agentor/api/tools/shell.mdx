---
title: "Shell Tool"
description: "ShellTool reference: let agents run bash and shell commands inside a controlled execution environment with timeouts and a custom executor callback."
---
