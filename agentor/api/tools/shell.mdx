...
Instead of running commands on your local machine, you can use a sandbox runtime for isolated execution:

```python  theme={null}
from agentor.tools import ShellTool
from agentor.runtime import SmolVMRuntime, E2BCodeInterpreterRuntime

# SmolVM - lightweight local VM
...
See the [sandbox runtimes guide](/agentor/guides/sandbox-runtimes) for details.
...
- [Sandbox runtime API](/agentor/api/sandbox-runtime) — SmolVMRuntime and E2BCodeInterpreterRuntime reference
