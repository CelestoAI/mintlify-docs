---
title: "GitHubTool"
description: "GitHubTool reference: agents can read repositories, create issues, open pull requests, and call the GitHub API using PyGithub and an access token."
---
