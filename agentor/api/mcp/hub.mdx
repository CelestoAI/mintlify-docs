---
title: "CelestoMCPHub"
description: "CelestoMCPHub reference: a context-managed client that aggregates multiple MCP servers and exposes their tools to your agents through a single endpoint."
---
