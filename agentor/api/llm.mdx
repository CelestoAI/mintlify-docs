---
title: "LLM"
description: "LLM class reference: a lightweight client for calling OpenAI, Anthropic, Gemini, and other LiteLLM models directly without the full agent framework."
---
