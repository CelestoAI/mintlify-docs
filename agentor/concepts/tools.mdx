---
title: "Tool System"
description: "How the Agentor tool system works: function tools, BaseTool classes, the global registry, and integration with external MCP servers for agent capabilities."
---
...
<CardGroup cols={2}>
  <Card title="MCP Integration" icon="plug" href="/agentor/concepts/mcp">
    Connect external MCP servers as tools
  </Card>

  <Card title="Skills System" icon="graduation-cap" href="/agentor/concepts/skills">
    Combine tools with contextual instructions
  </Card>

  <Card title="Tool search" icon="magnifying-glass" href="/agentor/concepts/tools#tool-search-api">
