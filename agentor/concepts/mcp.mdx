...
description: "Learn how the Model Context Protocol (MCP) connects LLMs to external tools, prompts, and resources, and how LiteMCP implements MCP natively on FastAPI."
---
