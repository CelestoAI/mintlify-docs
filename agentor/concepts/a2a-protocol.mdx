...
description: "How the Agent-to-Agent (A2A) protocol enables standardized JSON-RPC messaging, agent card discovery, and interoperability between AI agent frameworks."
---
...
<CardGroup cols={2}>
  ...
  <Card title="MCP Protocol" icon="plug" href="/agentor/concepts/mcp">
