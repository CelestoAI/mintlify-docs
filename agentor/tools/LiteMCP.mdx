...
description: "Build a custom MCP server with LiteMCP so agents can access your internal data sources and APIs through the Model Context Protocol over FastAPI."
---
