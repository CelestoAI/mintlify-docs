...
The Model Context Protocol (MCP) is a standardized way for LLM applications to interact with external data sources and functionality. MCP servers expose capabilities through three main abstractions:

**Tools** - Executable functions that perform actions and computations
**Resources** - Static or dynamic data accessible through URIs
