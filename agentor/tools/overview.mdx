...
This is done by providing a <Tooltip tip="A tool schema is a JSON containing the details of the function and its arguments">tool schema</Tooltip> to the LLM.
...
The tool result it then fed back to the LLM to answer the user question.
