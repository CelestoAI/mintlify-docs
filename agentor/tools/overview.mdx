...
**[Agentor](https://github.com/CelestoAI/agentor)** simplifies the tool use process by automatically generating the tool schema from the tool function, parsing the function signature and calling the function with the arguments.

To use a tool with Agentor, you need to define a function and decorate it with the `function_tool` decorator.
