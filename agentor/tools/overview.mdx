...
https://localhost:3000/agentor/tools/overview#tool-calling-with-openai-apiIn this section, we will learn about how LLMs make use of tools and what MCP Servers are. You can skip to the next section to learn about [tool use with Agentor](./tool-use).
...
MCP (Model Context Protocol) is a standard for communicating with LLMs that allows them to access external tools, APIs, and other resources.
