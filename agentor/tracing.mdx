...
description: "Capture and inspect agent runs, tool calls, and multi-step traces in the Celesto dashboard to debug failures and monitor agent behavior in production."
---
