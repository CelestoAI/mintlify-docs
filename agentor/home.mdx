---
title: "Agentor"
description: "Navigation hub for Agentor docs: setup, concepts, tool use, guides, and API reference."
---

# Agentor Documentation Hub

Agentor is Celesto's open-source framework for building production-ready AI agents with tool use, MCP support, and agent-to-agent communication.

<Info>
  Agentor is open source. Explore the repository at [github.com/CelestoAI/agentor](https://github.com/CelestoAI/agentor).
</Info>
