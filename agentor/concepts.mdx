...
description: "Legacy concepts overview covering the core Agentor building blocks — agents, tools, MCP servers, and deployment — and how they fit together end to end."
---
...
```python
from agentor.tools import CalculatorTool, GetWeatherTool
...
Tools can be:
- **Built-in** - Celesto provides common tools like weather, fetch, GitHub, and more
...
agent = Agentor(
    ...
    model="gpt-5",
    tools=[MCPServer(url="http://localhost:8000/mcp")]
)
```
