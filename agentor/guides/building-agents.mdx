...
* Build [durable agents](/agentor/guides/durable-agents) that persist state and resume after crashes
* Run commands in [sandbox runtimes](/agentor/guides/sandbox-runtimes) for secure execution
