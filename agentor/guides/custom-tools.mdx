...
description: "Build custom tools for Agentor agents using the function_tool decorator or BaseTool class to integrate APIs, databases, and external services."
---
...
<Warning>
  Any other string raises `ValueError: Tool <name> not found`. Agentor's other built-in tools are classes you import and instantiate — `CalculatorTool`, `GitHubTool`, `GmailTool`, `SlackTool`, and more in the [tools reference](/agentor/api/tools).
</Warning>
...
* Deploy tools with the [Celesto CLI](/agentor/guides/deployment)
