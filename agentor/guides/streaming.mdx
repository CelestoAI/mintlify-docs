...
description: "Stream Agentor agent responses token by token using stream_chat to lower perceived latency, show tool calls live, and support cancellation in your UI."
---
...
* Deploy streaming agents with the [Celesto CLI](/agentor/guides/deployment)
