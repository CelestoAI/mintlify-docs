...
description: "Monitor Agentor agents in production with built-in tracing — debug tool calls, track token usage and costs, and analyze multi-agent workflows."
---
...
* Deploy agents with [Celesto CLI](/agentor/guides/deployment) for automatic observability
* Learn about [streaming](/agentor/guides/streaming) to monitor responses in real-time
* Explore [agent communication](/agentor/guides/agent-communication) tracing patterns
