...
<CardGroup cols={2}>
  ...
  <Card title="Durable agents" icon="database">
    Build agents that persist every step to disk and can resume after crashes or restarts. Ideal for long-running, multi-step tasks.
  </Card>

  <Card title="Sandbox runtimes" icon="shield">
    Run agent shell commands in isolated environments using SmolVM (local VMs) or E2B (cloud sandboxes) for secure execution.
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  <Card title="Slack" icon="slack" href="https://join.slack.com/t/celestoai/shared_invite/zt-3qc7h8gno-Nb5_PElEWHDNnGqdVzC~4Q">
