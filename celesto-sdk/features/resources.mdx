...
<ParamField body="disk_size_mb" type="integer">
  Root disk storage inside the computer. More root disk helps when tools, package managers, or system-level build steps need more local runtime space. Range: 512-51200 MB. For large workspace files, use CelestoFS instead of increasing root disk size.
</ParamField>
