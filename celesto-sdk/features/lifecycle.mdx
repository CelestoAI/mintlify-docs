...
description: "Manage Celesto computer lifecycle with the SDK: create, stop, start, and delete workspaces so you can pause tasks, resume later, and free resources."
---
