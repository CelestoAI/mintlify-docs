...
The JavaScript SDK provides a `getTerminalConnection` method that returns the URL and headers you need to open a WebSocket terminal session. You can use it with any WebSocket library.
...
The method accepts either a computer ID (e.g., `cmp_abc123`) or a human-readable name. It resolves the name to the canonical ID automatically.
