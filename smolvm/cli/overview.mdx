---
title: "CLI overview"
description: "Overview of the SmolVM command-line interface for managing sandboxes and browser sessions"
---
...
The `smolvm snapshot` command has its own subcommands for managing VM snapshots:
