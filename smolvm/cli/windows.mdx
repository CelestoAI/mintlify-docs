...
description: "Build a reusable Windows 11 qcow2 image with smolvm windows build-image — an unattended install that runs end to end with no clicks and produces a ready-to-boot SmolVM Windows guest."
---
