...
SmolVM gives your app or AI agent a clean, disposable sandbox to execute commands and run browser sessions. This guide walks you through setup and your first sandbox in under 5 minutes.
