---
title: "Run your first SmolVM microVM sandbox"
sidebarTitle: "Quickstart"
description: "Install SmolVM and run your first isolated microVM sandbox in under five minutes — execute commands, check outputs, and tear it down with a context manager."
---
