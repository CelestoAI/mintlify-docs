...
description: "How SmolVM connects sandboxes to the internet while keeping them isolated from each other"
---
...
* Be reached from the host via [port forwarding](/smolvm/guides/port-forwarding)
...
See the [port forwarding guide](/smolvm/guides/port-forwarding) for more examples including automatic port allocation, multiple forwards, and troubleshooting.
