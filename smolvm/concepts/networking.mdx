...
flowchart TB
  subgraph Host["Host System"]
    VM1["VM 1<br/>172.16.0.2"]
    VM2["VM 2<br/>172.16.0.3"]
...
**Problem**: Firewall rules or route\_localnet not enabled
...
<Note>
  See [Security Model](/smolvm/concepts/security) for more details on network isolation and trust boundaries.
</Note>

## Next Steps

* Review [Security Model](/smolvm/concepts/security)
* Choose your [Backend](/smolvm/concepts/backends)
