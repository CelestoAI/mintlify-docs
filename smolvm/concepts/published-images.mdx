...
description: "How SmolVM boots from pre-built sandbox images so commands like smolvm claude start come up in seconds instead of minutes — covers the universal kernel, host-aware backend selection, and the manifest of published presets."
---
