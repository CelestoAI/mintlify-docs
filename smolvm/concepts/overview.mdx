...
4. **SmolVM connects over SSH** to execute your commands and return the output.
...
Builds or describes root filesystem images that can be launched as sandboxes. Use [custom images](/smolvm/guides/custom-images) when you want your own packages, init process, disk format, or boot mode.
