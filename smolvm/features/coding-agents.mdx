...
description: "Run Claude Code, Codex, Hermes, and Pi coding agents inside a SmolVM sandbox with full permissions — no more accept-changes prompts and no risk to your host machine."
---
