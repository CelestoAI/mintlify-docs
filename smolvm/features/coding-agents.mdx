...
description: "Run Claude Code, Codex, OpenCode, Hermes, and Pi coding agents inside a SmolVM sandbox with full permissions — no accept-changes prompts and no host risk."
---

SmolVM lets you run coding agents like Claude, Codex, OpenCode, Hermes, and Pi inside an isolated sandbox. The agent gets a full development environment — git credentials, dev tools, terminal access — but nothing it does can affect your host machine.
