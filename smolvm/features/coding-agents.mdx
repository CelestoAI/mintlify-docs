...
Each command creates a sandbox and prepares the selected agent. SmolVM forwards supported credentials and configuration from your machine when available.
...
See [Coding-agent preset environment variables](/smolvm/guides/environment-variables#coding-agent-presets) for OpenClaw credentials and configuration.
