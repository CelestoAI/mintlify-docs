...
description: "Share local folders and project files with a SmolVM sandbox using read-only or writable host mounts so agents can explore code without copying it first."
---
