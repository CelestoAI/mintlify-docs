...
description: "Manage the full SmolVM sandbox lifecycle — created, running, paused, and stopped states — and learn when to use the context manager versus manual control."
---
