...
description: "Pass configuration values, API keys, and secrets into a SmolVM sandbox at boot or runtime — variables are written to /etc/profile.d for new login shells."
---
