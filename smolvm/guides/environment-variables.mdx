...
description: "Pass configuration values, API keys, and secrets into a SmolVM sandbox at boot or runtime — works for both Linux and Windows guests with a unified Python API."
---
