...
description: "Access web servers, databases, and other services running inside a sandbox from your host"
---
...
<CardGroup cols={2}>
  <Card title="Environment variables" icon="code" href="/smolvm/guides/environment-variables">
    Inject configuration into sandboxes at runtime
  </Card>
  ...
  <Card title="Custom images" icon="box" href="/smolvm/guides/custom-images">
    Create custom images with pre-installed services
  </Card>
</CardGroup>
