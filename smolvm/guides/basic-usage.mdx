---
title: "Basic usage"
description: "Create sandboxes, run commands, and check results with SmolVM"
---
...
<Note>
  Command execution requires a communication path into the guest. Auto-configured VMs include one by default. For custom images, set `ssh_capable=True` only when your image starts SSH.
</Note>
