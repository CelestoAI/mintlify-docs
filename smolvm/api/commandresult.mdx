---
title: "CommandResult"
description: "CommandResult reference: an immutable Pydantic model with exit_code, stdout, stderr, and helper properties returned by SmolVM SSH command execution."
---
