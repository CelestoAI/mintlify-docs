---
title: "SSHClient"
description: "SSHClient reference: run commands on SmolVM guest VMs through persistent paramiko SSH connections, eliminating the per-call ssh process overhead."
---
...
<ParamField path="shell_kind" type='Literal["sh", "powershell", "cmd"]' default="sh">
