---
title: "SnapshotInfo"
description: "Metadata for a saved VM snapshot, including file paths and restore status"
---
...
* [Snapshots guide](/smolvm/guides/snapshots) — Step-by-step guide to using snapshots
