---
title: "Callback hooks Python reference"
description: "Reference for SmolVM's Callback base class, RunContext dataclass, and CommandBlockedError — the pre-run, post-run, and error hooks that fire around run()."
---
