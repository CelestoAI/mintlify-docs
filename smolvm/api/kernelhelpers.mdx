...
description: "ensure_base_kernel_for_backend reference for resolving, downloading, and caching the SmolVM base kernel matching a chosen backend and CPU architecture."
---
