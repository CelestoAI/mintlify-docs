...
Boot a pre-installed Windows 11 `qcow2` image. Requires a Linux host with KVM and the OVMF + `swtpm` packages installed. See the [Windows guests guide](/smolvm/guides/windows-guests) for prerequisites and limitations.
