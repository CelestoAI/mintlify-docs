...
description: "BrowserSession reference: launch a Chromium browser inside a SmolVM sandbox, drive it with Playwright, capture screenshots, and stream live with noVNC."
---
