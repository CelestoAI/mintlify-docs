...
with SmolVM.from_image(image, backend="firecracker", ssh_password="mysecret") as vm:
...
* [DockerRootfsBuilder](/smolvm/api/dockerrootfsbuilder) - Build raw ext4 root filesystems from Dockerfiles
* [BootImage](/smolvm/api/bootimage) - Describe a custom image before launch
* [VMConfig](/smolvm/api/vmconfig) - Configure lower-level VM boot and disk settings
