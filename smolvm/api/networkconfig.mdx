---
title: "NetworkConfig"
description: "NetworkConfig reference: an immutable Pydantic model defining a guest VM's IP, gateway, TAP device, MAC address, and SSH port forwarding settings."
---
