---
title: "Exceptions"
description: "Reference for SmolVM exception classes — SmolVMError, ValidationError, VMNotFoundError, NetworkError, FirecrackerAPIError — for robust error handling."
---
