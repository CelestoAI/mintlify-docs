...
description: "InternetSettings reference: restrict outbound network access from a SmolVM sandbox to an allowlist of domains using the VMConfig internet_settings field."
---
