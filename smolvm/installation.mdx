...
SmolVM ships several optional dependency groups you can install depending on your use case:
...
<CardGroup cols={2}>
  ...
  <Card title="Configuration" icon="gear" href="/smolvm/guides/basic-usage">
