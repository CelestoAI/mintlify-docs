...
<CardGroup cols={2}>
  ...
  <Card icon="database" title="Large artifacts" href="/cloud/features/petabyte-storage">
    Store generated data, datasets, logs, and project files in CelestoFS.
  </Card>
  <Card icon="users" title="Human handoffs" href="/cloud/features/persistence">
...
<CardGroup cols={2}>
  <Card icon="rotate" title="Lifecycle guide" href="/cloud/features/lifecycle">
    Learn create, stop, start, resume, and delete behavior.
  </Card>
  <Card icon="hard-drive" title="Persistent state" href="/cloud/features/persistence">
